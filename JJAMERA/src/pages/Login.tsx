      ...
      <div className="w-full max-w-md bg-obsidian border border-gray-deep/50 p-8 md:p-12 relative overflow-hidden rounded-[2rem] shadow-2xl">
        ...
        >
          ...
          <h1 className="text-[32px] md:text-[40px] font-extrabold tracking-tight mb-3">
            Welcome <span className="text-theme transition-colors duration-500 font-black">Back</span>
          </h1>
          <p className="text-white/60 text-[15px] font-medium">Log in to your account.</p>
        </motion.div>
        ...
        <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
          ...
          <MagneticButton type="submit" className="w-full mt-8 shadow-md">Sign In</MagneticButton>
        </form>
        ...
        <div className="mt-8 text-center relative z-10 border-t border-gray-deep/50 pt-6">
          <p className="text-white/60 text-[14px] font-medium">
            Don't have an account? <Link to="/signup" className="text-theme transition-colors duration-500 hover:text-white font-bold ml-1">Sign Up</Link>
          </p>
        </div>
      </div>
    </PageTransition>
